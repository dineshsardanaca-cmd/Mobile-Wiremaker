...
import { getFoodItemById, getMenuItemById } from "@/lib/data";
...
export default function FoodDetailPage() {
    ...
    const imageHint = image?.imageHint || 'food item';
                ...
                <div className="grid grid-cols-1 gap-8">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        {attributes && attributes.length > 0 && (
                            <div className="mb-6">
                                <h4 className="font-headline text-lg font-semibold mb-3">Dietary Information</h4>
